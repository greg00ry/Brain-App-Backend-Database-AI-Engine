...
import neuralNetworkRouter from './routes/neuralNetwork.js';
...
app.use('/api/neural', neuralNetworkRouter);
...
async function start() {
  ...
  app.listen(PORT, () => {
    ...
    console.log(`   GET    /api/neural`);
    console.log(`   POST   /api/neural`);
    console.log(`   POST   /api/neural/discover`);
    console.log(`   GET    /api/neural/entry/:entryId`);

...
const longTermMemorySchema = new Schema<ILongTermMemoryDoc>(
  {
    userId: {
      type: String,
      required: true,
...
export const LongTermMemory = mongoose.model<ILongTermMemoryDoc>('LongTermMemory', longTermMemorySchema);
